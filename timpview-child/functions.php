...
add_shortcode( 'aboutTimpview', 'abouttimpview_func' );
...
function intinlineLinkClass($intlink) {
    //global $post;
    	if('<a class="ext" href="https://timpviewbeta.provo.edu') {
	    	return str_replace('<a class="ext" href="https://timpviewbeta.provo.edu', '<a class="int" href="https://timpviewbeta.provo.edu"', $intlink);
    	} 
}
...
function intlistLinkClass($intlistlink) {
    	if('<li class="pdf"><a class="int" href="https://timpviewbeta.provo.edu') {
	    	return str_replace('<li class="pdf"><a class="int" href="https://timpviewbeta.provo.edu', '<li class="int"><a href="https://timpviewbeta.provo.edu', $intlistlink);
    	} 
}
